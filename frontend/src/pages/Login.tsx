...
export default function Login() {
  ...
  // Prefill only email (NOT password)
  useEffect(() => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-yellow-100 p-4">
      ...
      {message && (
        <div className={`fixed top-6 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-lg text-white font-medium shadow-lg z-50 transition-all duration-300 
      ...
      <form
        ...
        <input
          ...
          autoComplete="new-password"   // 🔥 FIXES autofill sending wrong password
          value={form.password}
          onChange={handleChange}
          required
